...
namespace AMSEMS.SubForms_DeptHead
{
    public partial class formChangeID : KryptonForm
    {
        ...
        public formChangeID(formAccountSetting form)
        {
            ...
            cn.Open();
            cm = new SqlCommand("Select ID from tbl_deptHead_accounts where Unique_ID = '" + FormDeptHeadNavigation.id + "'", cn);
            dr = cm.ExecuteReader();
            dr.Read();
            ...
            using (cn = new SqlConnection(SQL_Connection.connection))
            {
                ...
                else
                {
                    ...
                    using (SqlDataReader reader = cm.ExecuteReader())
                    {
                        ...
                        {
                            reader.Close();
                            cm = new SqlCommand("UPDATE tbl_deptHead_accounts SET ID = @NewValue WHERE Unique_ID = @ConditionValue", cn);
