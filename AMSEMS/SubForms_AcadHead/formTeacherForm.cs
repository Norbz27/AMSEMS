...
namespace AMSEMS.SubForms_AcadHead
{
    public partial class formTeacherForm : KryptonForm
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            using (SqlConnection cn = new SqlConnection(SQL_Connection.connection))
            {
                if (tbFname.Text.Equals(String.Empty) || tbLname.Text.Equals(String.Empty) || tbID.Text.Equals(String.Empty) || tbPass.Text.Equals(String.Empty) || tbRole.Text.Equals(String.Empty) || cbDepartment.Text.Equals(String.Empty))
                {
