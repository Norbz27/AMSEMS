        ...
        private void btnDone_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (cn = new SqlConnection(SQL_Connection.connection))
                {
                    ...
                    {
                        cn.Open();
                        cm = new SqlCommand("Select ID from tbl_acadHead_accounts where Password = @CurrentPassword", cn);
                        ...
                        using (SqlDataReader reader = cm.ExecuteReader())
                        {
                            ...
                            {
                                reader.Close();
                                cm = new SqlCommand("UPDATE tbl_acadHead_accounts SET Password = @NewValue WHERE Unique_ID = @ConditionValue", cn);
