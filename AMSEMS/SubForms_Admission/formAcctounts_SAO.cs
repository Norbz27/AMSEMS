...
namespace AMSEMS.SubForms_Admin
{
    public partial class formAccounts_SAO : Form
    {
            ...
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    if (saveFileDialog.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        string query = "SELECT ID, UPPER(Firstname) as Firstname, UPPER(Middlename) as Middlename, UPPER(Lastname) as Lastname FROM tbl_sao_accounts";
        ...
        private void dgvsao_KeyDown(object sender, KeyEventArgs e)
        {
