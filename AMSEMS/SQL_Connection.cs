namespace AMSEMS
{
    internal class SQL_Connection
    {
        ...
        //Connect locally
        //public static string connection = @"Server=192.168.1.10;Database=db_Amsems;User Id=nor;Password=12345;";

        //ngrok
        //static string server = "0.tcp.ap.ngrok.io,11540"; // Ngrok tunnel URL
