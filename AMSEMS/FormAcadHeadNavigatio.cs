...
namespace AMSEMS
{
    public partial class FormAcadHeadNavigatio : KryptonForm
    {
        SqlCommand cm;
        SqlDataReader dr;
        ...
        public FormAcadHeadNavigatio(String id1)
        {
            InitializeComponent();
            ...
            setCalendar();
            id = id1;
            SubForms_AcadHead.formDashboard.setForm(this);
            OpenChildForm(new SubForms_AcadHead.formDashboard());
        ...
        public async void notification()
        {
            ...
            void PusherOnConnected(object sender)
            {
                ...
                channel.Bind(FormAcadHeadNavigatio.id, (dynamic data) =>
                {
                    loadData();
                });
            }
        ...
        public void loadData()
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(SQL_Connection.connection))
                {
                    ...
                    cm = new SqlCommand("Select Profile_pic from tbl_acadHead_accounts where Unique_ID = " + id + "", cn);
        ...
        private void btnSubjects_Click(object sender, EventArgs e)
        {
            isCollapsed = false;
            timer1.Start();
            OpenChildForm(new SubForms_AcadHead.formSubjects());
        ...
        private void btnSettings_Click(object sender, EventArgs e)
        {
            ...
            timer1.Start();
            this.kryptonSplitContainer1.Panel2Collapsed = true;
            OpenChildForm(new SubForms_AcadHead.formSettings(this));
        ...
        {
            SubForms_AcadHead.formAccounts_Teachers.setAccountName("Teachers Accounts");
            SubForms_AcadHead.formAccounts_Teachers.setRole(6);
            this.kryptonSplitContainer1.Panel2Collapsed = true;
            OpenChildForm(new SubForms_AcadHead.formAccounts_Teachers());

        }

        private void btnDeptHead_Click(object sender, EventArgs e)
        {
            SubForms_AcadHead.formAcctounts_DeptHead.setAccountName("Department Head Accounts");
            SubForms_AcadHead.formAcctounts_DeptHead.setRole(2);
            this.kryptonSplitContainer1.Panel2Collapsed = true;
            OpenChildForm(new SubForms_AcadHead.formAcctounts_DeptHead());
        }

        private void btnGuidance_Click(object sender, EventArgs e)
        {
            SubForms_AcadHead.formAcctounts_Guidance.setAccountName("Guidance Associate Accounts");
            SubForms_AcadHead.formAcctounts_Guidance.setRole(3);
            this.kryptonSplitContainer1.Panel2Collapsed = true;
            OpenChildForm(new SubForms_AcadHead.formAcctounts_Guidance());
        }

        private void btnSAO_Click(object sender, EventArgs e)
        {
            SubForms_AcadHead.formAccounts_SAO.setAccountName("Student Affairs Officer Accounts");
            SubForms_AcadHead.formAccounts_SAO.setRole(4);
            this.kryptonSplitContainer1.Panel2Collapsed = true;
            OpenChildForm(new SubForms_AcadHead.formAccounts_SAO());
        }

        private void btnStudents_Click(object sender, EventArgs e)
        {
            SubForms_AcadHead.formAccounts_Students.setAccountName("Students Account");
            SubForms_AcadHead.formAccounts_Students.setRole(5);
            this.kryptonSplitContainer1.Panel2Collapsed = true;
            OpenChildForm(new SubForms_AcadHead.formAccounts_Students());
        }
