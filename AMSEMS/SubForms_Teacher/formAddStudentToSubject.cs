...
{
    public partial class formAddStudentToSubject : KryptonForm
    {
        ...
        public formAddStudentToSubject(formSubjectOverview formSubjectOverview)
        {
            InitializeComponent();
            InitializeListBox();
        ...
        private void tbSearchStudent_TextChanged(object sender, EventArgs e)
        {
            ...
            if(dgvSectionStudents.Rows.Count > 0)
            {
